...
MAX_PRICE_STALE_S = int(_env_number("KILL_SWITCH_MAX_PRICE_STALE_S", "300"))          # 5m
MAX_EVENT_STALE_S = int(_env_number("KILL_SWITCH_MAX_EVENT_STALE_S", "3600"))         # 1h
MAX_PRED_STALE_S  = int(_env_number("KILL_SWITCH_MAX_PRED_STALE_S", "900"))           # 15m

# Heartbeat freshness (job_heartbeats.ts_ms)
MAX_JOB_STALE_S   = int(_env_number("KILL_SWITCH_MAX_JOB_STALE_S", "600"))            # 10m
...
KILL_SWITCH_DAILY_DRAWDOWN_PCT = float(_env_number("KILL_SWITCH_DAILY_DRAWDOWN_PCT", "0.05"))
KILL_SWITCH_ROLLING_DRAWDOWN_PCT = float(_env_number("KILL_SWITCH_ROLLING_DRAWDOWN_PCT", "0.12"))
KILL_SWITCH_ROLLING_DRAWDOWN_LOOKBACK_DAYS = int(_env_number("KILL_SWITCH_ROLLING_DRAWDOWN_LOOKBACK_DAYS", "7"))
KILL_SWITCH_VAR_LOOKBACK_POINTS = int(_env_number("KILL_SWITCH_VAR_LOOKBACK_POINTS", "250"))
KILL_SWITCH_VAR_CONFIDENCE = float(_env_number("KILL_SWITCH_VAR_CONFIDENCE", "0.99"))
KILL_SWITCH_VAR_MIN_HISTORY = int(_env_number("KILL_SWITCH_VAR_MIN_HISTORY", "30"))
KILL_SWITCH_CONCENTRATION_MAX_SINGLE = float(_env_number("KILL_SWITCH_CONCENTRATION_MAX_SINGLE", "0.35"))
KILL_SWITCH_CONCENTRATION_MAX_TOP3 = float(_env_number("KILL_SWITCH_CONCENTRATION_MAX_TOP3", "0.70"))
KILL_SWITCH_CONCENTRATION_MAX_SINGLE = float(_env_number("KILL_SWITCH_CONCENTRATION_MAX_SINGLE", "0.35"))
KILL_SWITCH_CONCENTRATION_MAX_TOP3 = float(_env_number("KILL_SWITCH_CONCENTRATION_MAX_TOP3", "0.70"))
KILL_SWITCH_COOLDOWN_MINUTES = float(_env_number("KILL_SWITCH_COOLDOWN_MINUTES", "60"))
MODEL_AWARE_KILL_SWITCH = os.environ.get("MODEL_AWARE_KILL_SWITCH", "1") == "1"
KILL_SWITCH_MODEL_MAX_DRAWDOWN = float(_env_number("KILL_SWITCH_MODEL_MAX_DRAWDOWN", "0"))
KILL_SWITCH_MODEL_MAX_CONSECUTIVE_LOSSES = int(_env_number("KILL_SWITCH_MODEL_MAX_CONSECUTIVE_LOSSES", "0"))
KILL_SWITCH_MODEL_LOOKBACK_ROWS = int(_env_number("KILL_SWITCH_MODEL_LOOKBACK_ROWS", "250"))
