...
Provides:
- lightweight component health snapshots
- rolling success-rate metrics
- deterministic retry backoff calculations
"""
...
def backoff_delay_s(attempt: int, *, base_s: float, max_s: float) -> float:
    """Return a deterministic exponential backoff delay capped at ``max_s``."""
...
def record_component_health(
    ...
    *,
    ...
    """Record a component-health snapshot and emit matching observability metrics."""
...
def get_component_health_snapshot(
    ...
    *,
    ...
    """Return one component snapshot or the full health map with age metadata."""
...
def record_rolling_rate(
    ...
    *,
    ...
    """Update a rolling success-rate series and emit its aggregate gauge."""
