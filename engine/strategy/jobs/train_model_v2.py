...
Job entrypoint wrapper for the main model-v2 training flow with lock and
heartbeat handling.
"""
...
from ops.train_model_v2 import main
...
if __name__ == "__main__":
    ...
    # The wrapper owns job lock / heartbeat semantics; the imported trainer owns
    # the actual model-building logic.
