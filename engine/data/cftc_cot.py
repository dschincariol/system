...
DEFAULT_COT_CONTRACT_SPECS: Tuple[CotContractSpec, ...] = (
    ...
    CotContractSpec("6S", "legacy", "SWISS FRANC", ("USDCHF", "6S"), "fx"),
    CotContractSpec("6C", "legacy", "CANADIAN DOLLAR", ("USDCAD", "6C"), "fx"),
    CotContractSpec("6A", "legacy", "AUSTRALIAN DOLLAR", ("AUDUSD", "6A"), "fx"),
    CotContractSpec("6N", "legacy", "NEW ZEALAND DOLLAR", ("NZDUSD", "6N"), "fx"),
