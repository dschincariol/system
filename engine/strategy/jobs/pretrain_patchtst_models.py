"""Job entrypoint for masked self-supervised PatchTST pretraining."""
...
from engine.strategy.models.patchtst import pretrain_main

JOB_NAME = "pretrain_patchtst_models"
