"""Job entrypoint for governed tabular foundation challengers."""
...
from engine.strategy.models.tabular_challenger import main

JOB_NAME = "train_tabular_challenger_models"
