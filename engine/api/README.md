...
- [server.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\server.py)
  API server assembly.
- [http_transport.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\http_transport.py)
  Transport-layer request/response plumbing.
- [http_parsing.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\http_parsing.py)
  Parsing and normalization helpers.
- [api_system.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_system.py)
  System-level dashboard and runtime endpoints.
- [api_operator_handlers.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_operator_handlers.py)
  Operator-facing status and control handlers.
- [api_jobs.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_jobs.py)
  Job status, history, and job-control endpoints.
- [api_read.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_read.py)
  Core read APIs.
- [api_write.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_write.py)
  Mutating APIs.
- [api_dashboard_reads.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_dashboard_reads.py)
  Dashboard-specific read aggregation.
- [api_ops.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_ops.py)
  Route metadata for ops, diagnostics, execution analytics, and governance read surfaces.
- [api_ops_handlers.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_ops_handlers.py)
  Thin handler implementations for the ops route set.
- [api_governance.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\api\api_governance.py)
  Governance-specific handlers for promotion status, rollback, calibration, and governance summaries.
- [../terminal/api/api_terminal.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\terminal\api\api_terminal.py)
  Read-mostly API surface used by the standalone browser terminal.
- [../terminal/api/api_terminal_orders.py](c:\Users\dschi\Documents\GitHub\Trading-System-\engine\terminal\api\api_terminal_orders.py)
...
- [routes/data_sources_routes.py](c:\Users\dschi\Documents\GitHub\Trading-System-\routes\data_sources_routes.py)
