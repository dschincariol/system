...
Job entrypoint wrapper for embedding-model retraining with lock and heartbeat
management.
"""
...
from engine.strategy.train_embed_models import main
...
Job entrypoint wrapper for embedding model retraining.
"""
