...
- **Phase 2 (P1, Months 3–6) — Intelligence:** PARTIAL/DONE in current code for LightGBM, XGBoost, sklearn GBM, PatchTST, FinBERT/NLP feature groups, causal scoring, Ridge meta-ensemble blending, and shadow RL. Graph models, TabNet/iTransformer, and broader LLM transcript workflows remain future work.
