...
CATALOG: tuple[Hyperparam, ...] = (
    ...
    Hyperparam("max_rows", "tabular_foundation_challenger", "int", 10000, low=200, high=50000, log=True, env_name="TABULAR_CHALLENGER_MAX_ROWS"),
    Hyperparam("max_features", "tabular_foundation_challenger", "int", 500, low=20, high=2000, log=True, env_name="TABULAR_CHALLENGER_MAX_FEATURES"),
    Hyperparam("timeout_s", "tabular_foundation_challenger", "int", 900, low=60, high=7200, log=True, env_name="TABULAR_CHALLENGER_TIMEOUT_S"),
